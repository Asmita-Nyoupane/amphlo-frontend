...
const Mission = () => {
    return (
        <section className="flex flex-col md:flex-row-reverse items-center gap-12" data-aos="fade-up">
            ...
            <div className="md:w-1/2 flex-1">
                <h3 className="text-4xl font-bold text-mainColor mb-4">Our Mission</h3>
